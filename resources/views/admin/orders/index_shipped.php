...
$order = query("select*from orders where status = 4 order by order_time desc");
?>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">List Order Shipped</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">List Order Shipped</h3>
                                </div>
                                <!-- /.card-header -->
