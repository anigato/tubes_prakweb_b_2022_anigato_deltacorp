...
$order = query("select*from orders where status = 0 order by order_time desc");
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Order Waiting to Confirm Payment</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">List Order Waiting to Confirm Payment</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">List Order Waiting to Confirm Payment</h3>
                                </div>
                                <!-- /.card-header -->
