      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-info">
            ...
            <div class="card-body">
              <form class="row needs-validation" novalidate method="post" action="/admin/brand/{{ $brand->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" name="name" id="name" placeholder="Brand Name" required value="{{ old('name', $brand->name) }}">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="custom-file mb-2">
                      <input type="file" class="custom-file-input form-control" name="img" id="img" onchange="showImage(this);" value="{{ old('img', $brand->img) }}">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 mx-auto d-block">
                        ...
                        <img class="rounded" src="{{ asset('storage/'.$brand->img) }}" alt="" style="width: 100%;">
                      </div>
                    </div>
                  </div>
                </div>
