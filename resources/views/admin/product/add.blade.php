                                ...
                                <form class="row needs-validation" novalidate method="post" action="{{ url('admin/product') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" name="category_id" >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Brand</label>
                                            <div class="input-group mb-3">
                                                <select class="custom-select text-uppercase" name="brand_id" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" name="capacity" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Stock</label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" name="stok" id="stok" placeholder="Product Stock"  onkeypress="return onlyNumber(event)" minlength="2" maxlength="2">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-btn-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="price" id="price" placeholder="Product Price"  onkeypress="return onlyNumber(event)" minlength="5" maxlength="8">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Weight</label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" name="weight" id="weight" placeholder="Product Weight"  onkeypress="return onlyNumber(event)" minlength="3" maxlength="4">
                                                        <div class="input-group-append">
